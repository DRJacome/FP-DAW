...
$consulta = mysqli_query($conexion, $datosTienda);

// while ($registro = mysqli_result($consulta)) {
// while ($registro = mysqli_fetch_array(mysqli_result($consulta))) {
// while ($registro = $consulta) {
...
///////////////////// Salida por pantalla del catálogo //////////////////////
?>
<div class="row">
  <div class="col-md-7">
    <?php
            ...
            <tr>
              ...
              <td>
                <form action="pagina.php" method="post">
                  <input type="hidden" name="ejercicio" value="4_3_3/03_detalle">
              ...
              <td>
                <form action="pagina.php" method="post">
                  <input type="hidden" name="ejercicio" value="4_3_3/03">
                  <input type="hidden" name="codigo" value="<?= $codigo ?>">
