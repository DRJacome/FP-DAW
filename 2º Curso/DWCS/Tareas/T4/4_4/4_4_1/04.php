...
<table class="table table-striped">
    ...
    <tr>
      ...
      <td>
        <form action="pagina.php" method="post">
          <input type="hidden" name="ejercicio" value="4_4_1/04_borrar_articulo_confirmacion">
      ...
      <td>
        <form action="pagina.php" method="post">
          <input type="hidden" name="ejercicio" value="4_4_1/04_modificar_articulo">
          <input type="hidden" name="codigo" value="<?= $registro['codigo'] ?>">
          <input type="hidden" name="descripcion" value="<?= $registro['descripcion'] ?>">
          <input type="hidden" name="precio_compra" value="<?= $registro['precio_compra'] ?>">
          <input type="hidden" name="precio_venta" value="<?= $registro['precio_venta'] ?>">
      ...
      <td>
        <form action="pagina.php" method="post">
          <input type="hidden" name="ejercicio" value="4_4_1/04_entrada_articulo">
          <input type="hidden" name="codigo" value="<?= $registro['codigo'] ?>">
          <input type="hidden" name="descripcion" value="<?= $registro['descripcion'] ?>">
          <input type="hidden" name="precio_compra" value="<?= $registro['precio_compra'] ?>">
          <input type="hidden" name="precio_venta" value="<?= $registro['precio_venta'] ?>">
      ...
      <td>
        <form action="pagina.php" method="post">
          <input type="hidden" name="ejercicio" value="4_4_1/04_salida_articulo">
          <input type="hidden" name="codigo" value="<?= $registro['codigo'] ?>">
          <input type="hidden" name="descripcion" value="<?= $registro['descripcion'] ?>">
          <input type="hidden" name="precio_compra" value="<?= $registro['precio_compra'] ?>">
          <input type="hidden" name="precio_venta" value="<?= $registro['precio_venta'] ?>">
          <input type="hidden" name="stock" value="<?= $registro['stock'] ?>">
          <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-log-out"></span> Salida</button>
        </form>
      </td>
    </tr>
  <?php
  ...
  <tr>
    ...
    <td>
      <form action="pagina.php" method="post">
        <input type="hidden" name="ejercicio" value="4_4_1/04">
